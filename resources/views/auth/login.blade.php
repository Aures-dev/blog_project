...
<div class=" mx-auto py-8 flex items-center justify-center w-full dark:bg-gray-950">
	<div class="bg-white dark:bg-gray-900 shadow-md rounded-lg px-8 py-6 w-3/6">
		<h1 class="text-2xl font-bold text-center mb-4 dark:text-gray-200">Se connecter!</h1>
